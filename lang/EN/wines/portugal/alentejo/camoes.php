...
<html>
<head>
<title>A Dias d'Vinho - Camões</title>
...
<body>
	...
	<div class="banner banner-bg">
		...
		<div class="header">
			...
			<div class="container">
				<div class="logo">
					<!--<h1><a href="../index.php">A Dias de <span>Vinho</span></a></h1>-->
					<a href="/adiasvinho/index.php"><img src="/adiasvinho/images/logoWhite.png" height="auto" width="125"></a>
				</div>
				<div class="top-nav">
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-top: 2%">
							<ul id="ulMenu" class="nav navbar-nav">
								<li><a id="aHome" href="/adiasvinho/index.php" class="active">Home</a></li>
								<li><a id="aSobre" href="/adiasvinho/sobre.php">About</a></li>
								<li><a id="aVinhos" href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Wines<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<!--<li><a class="hvr-bounce-to-bottom" href="gallery.html">Portugal</a></li>-->
										<!-- Area para quando houver mais do que um vinho por pais -->
										<li class="dropdown-submenu">
									  	...
									  	<li class="dropdown-submenu">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown-submenu" role="button" aria-haspopup="true" aria-expanded="false">Spain<span class="caret"></span></a>
											<ul class="dropdown-menu" style="margin-top: 0.5px; padding-left:10px">
											  <li><a tabindex="-1" href="/adiasvinho/lang/en/wines/espanha/rias_baixas/" style="margin-top: 5%">Rias Baixas</a></li>
											</ul>
									  	</li>
					...
					<div class="left-blog left-single">
						<div class="blog-left">
							<div class="single-left-left">
								<h1>Camões</h1>
								<div class="col-md-4">
									<center><img src="/adiasvinho/images/camoes.jpg" alt="camoes" style="height: 500px; width: auto"/></center>
								</div>
							</div>
							<div class="blog-left-bottom">
								<strong><p>CAMÕES - GRANDE ESCOLHA <br><p></strong>
							</div>
							<br>
							<div class="blog-left-bottom">
	...
	<div class="container">
		<div class="footer-grids">
			...
			<div class="col-md-4 footer-grid">
				<h3>Details</h3>
				<ul>
					<li><a href="/adiasvinho/about.html">About</a></li>
					<li><a href="/adiasvinho/codes.html">Wines</a></li>
					<li><a href="/adiasvinho/contact.html">Contact</a></li>
				</ul>
			</div>
			<div class="col-md-4 footer-grid">
				<h3>Contact</h3>
